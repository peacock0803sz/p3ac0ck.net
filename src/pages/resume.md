...
PythonによるWebアプリケーション開発と、Google Cloudを中心としたクラウドインフラ構築の双方に5年以上の経験があります。特にTerraformを用いたIaCによるインフラ設計・構築・運用に強みを持ち、前職のGoogle Cloudパートナー企業では100台以上のサーバー移行プロジェクトで実装リーダーを担当しました。  
...
| Go (1.18 ~): 全般                   | 標準ライブラリ、自動化CLIなど                | 4      | 3    | 2    |
| Rust: 全般                          | Web、標準ライブラリ、自動化CLIなど           | 0      | 4    | 0    |
| Webフロントエンド (ES2015 ~)        | React (Next.js), Vue.js                      | 3      | 2    | 5    |
...
| コンテナオーケストレーション        | Kubernates                                   | 1      | 4    | 0    |
...
## 2025-10-01 ~ 現在: [GROOVE X 株式会社](https://groove-x.com)

所属: KIBAN Working Group / クラウドチーム

### 業務内容

自社プロダクト「LOVOT」を支えるクラウド環境の運用、機能開発

- 開発体制: スクラム (LeSS / Large Scale Scrum)
- 使用技術: Go, Google Cloud, Cloudflare, Terraform, Kubernatesなど
- 担当業務: Google Cloud環境のコスト最適化、インフラ環境の改善など

## 2022-12-01 ~ 2025-09-30: [株式会社トップゲート](https://topgate.co.jp)(合併前) / [株式会社G-gen](https://g-gen.co.jp)
...
- 技術ブログ執筆
    ...
    - [Google Cloud Next Tokyo '24 速報レポート](https://blog.g-gen.co.jp/entry/google-cloud-next-tokyo-24-platform-engineering-introduction) (2024-08-02)
- [Google Cloud Modern Infra Summit '25](https://cloudonair.withgoogle.com/events/modern-infra-summit-25q1) (2025-03-06)にて「Google Cloud で IaC: Terraform 開発と運用のイロハ集」でスポンサー登壇
